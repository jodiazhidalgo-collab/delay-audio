...
description: Reconstruir y validar el servicio Docker principal delay-audio. Usar despues de cambios en web, backend, frontend, Docker, requisitos o configuracion funcional.
---
...
1. Confirmar que el cambio afecta al servicio principal `delay-audio`.
